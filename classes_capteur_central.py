...
class Robot(): # classe permettant de gerer la simulation du comportement du robot, qui est forme de 7 images : 5 capteurs et 2 roues
    ...
    def __init__(self, image_roue, image_capteur, dimensions_image_roue, dimensions_image_capteur, l, d, r, z, vitesse_de_marche, coeff, largeur_chemin):
        """
